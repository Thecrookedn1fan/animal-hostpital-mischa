...
st.set_page_config(page_title="Smart Hostpital", page_icon="🏥", layout="wide")
...
DEPT_INFO = {
    ...
    'Neurology': {
        ...
        'desc':'Specialises in brain, spine, and nervous system',
...
st.markdown("""
<!-- COLOR1 -->
<div style="background:linear-gradient(135deg,#3606f6 0%,#7083a3 60%,#11054e 100%);
...
with st.form("triage_form"):
    ...
    st.markdown("""
    <!-- COLOR2 -->
    <div style="background:#384ec0;border:1px solid #636fc6;border-radius:14px;
    ...
    st.markdown("""
    <!-- COLOR3 -->
    <div style="background:#d4f309;border:1px solid #cbdc0d;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#25f20a;color:rgb(246, 246, 6);border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">2</span>
            <span style="font-size:16px;font-weight:600;color:#455619;">How long have you had these symptoms?</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <!-- COLOR4 -->
    <div style="background:#85d892;border:1px solid #409f59;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#25f20a;color:rgb(53, 226, 37);border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">3</span>
            <span style="font-size:16px;font-weight:600;color:#083a14;">How would you rate to the severity?</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <!-- COLOR5 -->
    <div style="background:#f60909;border:1px solid hsl(313, 81%, 76%);border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#f20a8a;color:rgb(129, 109, 122);border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">4</span>
            <span style="font-size:16px;font-weight:600;color:#37062a;">Do you have any of the following?</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <!-- COLOR6 -->
    <div style="background:#09f6f6;border:1px solid #c1e7f4;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#210af2;color:white;border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">5</span>
            <span style="font-size:16px;font-weight:600;color:#566d9b;">Patient Information</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
if submitted:
    ...
    st.markdown("---")
    st.markdown("""
    <div style="font-size:22px;font-weight:700;color:#111827;margin-bottom:4px;">AI Recomendation</Ri:a></div>
